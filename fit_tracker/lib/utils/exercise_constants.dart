...
const Map<String, IconData> exerciseRecommendedIcons = {
  ...
  'Decline Press': Icons.fitness_center,
  'Dumbbell Flyes': Icons.fitness_center,
  'Cable Flyes': Icons.cable,
  // Legs
  ...
  'Preacher Curls': Icons.fitness_center,
  'Skull Crushers': Icons.fitness_center,
  'Diamond Pushups': Icons.accessibility,
  // Shoulders
  ...
  'Elliptical': Icons.directions_run,
  'Stair Climber': Icons.trending_up,
  'Rowing Machine': Icons.directions_boat,
  // Core
